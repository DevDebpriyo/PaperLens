...
const faqs: FAQItem[] = [
    {
        ...
        answer:
            "No. PaperLens is a complete zero-setup environment that handles Rust, Soroban CLI, and all dependencies in the cloud.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Absolutely. PaperLens automatically generates TypeScript bindings so you can integrate contracts into your frontend immediately.",
    },
];
