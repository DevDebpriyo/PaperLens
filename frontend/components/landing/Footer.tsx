    ...
    return (
        ...
        <Toast.Viewport />
            ...
            <div
                ...
                ref={container}
            >
                <div className='sm:container pl-10 px-4 mx-auto'>
                    ...
                    <div className="w-full h-full flex justify-center items-end pointer-events-none select-none leading-none pb-0 pt-10">
                        <h1 ref={ref} className={`${font.className} text-[14vw] md:text-[16vw] text-[#87E64B] leading-[0.75] mix-blend-normal tracking-wide uppercase whitespace-nowrap drop-shadow-[12px_12px_0px_rgba(0,0,0,1)]`} style={{ WebkitTextStroke: '3px black' }}>
                            {['P', 'a', 'p', 'e', 'r', 'L', 'e', 'n', 's'].map((letter, i) => (
                                <motion.span
                                    key={i}
                                    custom={i}
                                    variants={variants}
                    ...
                    <div className='flex md:flex-row flex-col-reverse gap-3 justify-between py-2 text-black'>
                        <span className='font-medium'>
                            &copy; 2026 PaperLens. All Rights Reserved.
                        </span>
