      ...
      <div className="flex-grow border-2 border-black border-t-[6px] p-4 rounded-xl bg-white/80 relative overflow-hidden flex flex-col shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="space-y-1 pt-1 opacity-95 text-xs">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.1 }}>
            <span className="text-purple-600">use</span> <span className="text-black">PaperLens_sdk::contract;</span>
          </motion.div>
...
export default function PaperLensBentoGrid() {
  return (
    <section id="features" className="min-h-screen flex flex-col items-center justify-center px-4 py-24 md:px-8 md:pt-40 md:pb-24 border-t border-white/10">
      ...
      <div className="max-w-[90%] w-full grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(320px,auto)]">
        ...
        <Card
          ...
          description="From notebook to production, prototype, iterate, and deploy your application with PaperLens."
